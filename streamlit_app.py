...
# Ejecutar la verificación al inicio (NO llamar a run_scan aquí)
ensure_history()

# ============================================================
# FUNCIÓN DE ESCANEO (Solo se ejecuta desde el botón)
# ============================================================
def run_scan():
    ...
    try:
        ...
        st.success(f"✅ Escaneo completado. {len(signals)} oportunidades encontradas.")
    except Exception as e:
...
# ============================================================
# PESTAÑAS (Mantener igual que antes, solo se muestran)
# ============================================================
tabs = st.tabs([
    "📊 Estado General",
    "🎯 Último Trade",
